...
<html lang="it">
    <head>
        ...
        <style>
            body { background-color: #212529; padding-top: 100px; }
            .menu-item { margin-bottom: 2rem; border-bottom: 1px dashed rgba(255,255,255,0.2); padding-bottom: 15px; }
            .price { float: right; color: #ffc800; font-weight: 700; }
            .btn-menu-custom { color: #fff; border: 1px solid #ffc800; margin: 5px; }
            .btn-menu-custom.active { background-color: #ffc800 !important; color: #212529 !important; }
            .nav-tabs { border-bottom: none; }
            .btn-add { font-size: 0.8rem; padding: 2px 12px; border-radius: 20px; }
        </style>
    </head>
    <body>
...
<div id="lista-carrello">
    ...
    <% if (carrello != null && !carrello.isEmpty()) { %>
        <div class="mt-4 p-3 rounded d-flex justify-content-between align-items-center" style="background-color: #2c3034; border: 1px solid #ffc800;">
    ...
    <% } %>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="index.html"><i class="fas fa-arrow-left me-2"></i>Torna alla Home</a>
                <%-- Link veloce al Carrello per vedere se funziona --%>
                <button class="btn btn-outline-warning btn-sm" type="button" data-bs-toggle="offcanvas" data-bs-target="#carrelloLaterale">
    <i class="fas fa-shopping-cart"></i> Carrello 
    <span class="badge bg-warning text-dark">
        <%= (session.getAttribute("carrello") != null) ? ((Map)session.getAttribute("carrello")).size() : 0 %>
    </span>
</button>
            </div>
        </nav>
        ...
        <footer class="footer py-4 bg-dark text-white text-center">
            <div class="container"><small>Idea Bistrot &copy; 2026</small></div>
        </footer>
